...
class TrucksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create truck" do
    assert_difference('Truck.count') do
      post trucks_url, params: { truck: { end_time: @truck.end_time, name: @truck.name, start_time: @truck.start_time } }
    end
  ...
  test "should update truck" do
    patch truck_url(@truck), params: { truck: { end_time: @truck.end_time, name: @truck.name, start_time: @truck.start_time } }
